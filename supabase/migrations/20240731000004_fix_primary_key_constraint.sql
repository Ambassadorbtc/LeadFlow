-- Fix the primary key constraint issue
DO $$
BEGIN
  ...
  BEGIN
    ...
    IF test_user_exists THEN
      ...
      SELECT id INTO existing_user_id FROM public.users WHERE email = 'ibbysj@gmail.com';
  ...
  BEGIN
    ...
    ELSE
      -- Get the admin ID from auth.users
      ...
      SELECT id INTO existing_admin_id FROM public.users WHERE email = 'admin@leadflowapp.online';
