...
export default async function CompaniesPage({
  ...
  return (
    <div className="px-4 py-8 w-full bg-[#f6f6f8] dark:bg-gray-900">
      {/* Header Section */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {companies && companies.length > 0 ? (
          ...
          <div className="col-span-full bg-white dark:bg-gray-800 rounded-lg shadow p-10 text-center text-gray-500 dark:text-gray-400">
            ...
            <Link
              href="/dashboard/companies/add"
              className="bg-[#4f46e5] text-white px-4 py-2 rounded-lg inline-flex items-center gap-2 hover:bg-[#4338ca] transition-colors shadow-sm"
            >
              <Plus className="h-5 w-5" />
              <span>Add Company</span>
            </Link>
